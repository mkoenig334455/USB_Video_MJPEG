...
/** @defgroup USBD_VIDEO_Private_Variables
  * @{
  */
USBD_VIDEO_HandleTypeDef USBD_VIDEO_Instance;
...
/**
  ...
  * @retval status
  */
 uint8_t USBD_VIDEO_DeInit(USBD_HandleTypeDef *pdev, uint8_t cfgidx)
{
  UNUSED(cfgidx);
...
/**
  ...
  * @retval status
  */
 uint8_t USBD_VIDEO_SOF(USBD_HandleTypeDef *pdev)
{
  USBD_VIDEO_HandleTypeDef *hVIDEO = (USBD_VIDEO_HandleTypeDef *)pdev->pClassData_UVC;
